...
background_music = pygame.mixer.music.load("./assets/music/music_bg_py.mp3")
...
screen_wallpaper = pygame.image.load("./assets/img/fondo_apto_parallax-transformed.jpeg") #assets\img\fondo_apto_parallax.jpg #./assets/img/fondo.png
